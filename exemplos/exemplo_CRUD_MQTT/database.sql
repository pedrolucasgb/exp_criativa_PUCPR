...
CREATE TABLE IF NOT EXISTS sensor_readings (
    ...
    INDEX idx_sensor_datetime (sensor_id, read_datetime DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('Temperatura Sala 1', 'DHT', 'DHT22', '°C', '/sensores/temp/sala1', TRUE),
('Umidade Sala 1', 'DHT', 'DHT22', '%', '/sensores/humidity/sala1', TRUE),
('Pressão Atmosférica', 'BMP', 'BMP280', 'hPa', '/sensores/pressure/outdoor', TRUE),
('Luminosidade', 'LDR', 'GL5528', 'lux', '/sensores/light/sala1', TRUE)
